...
class MsgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create msg" do
    assert_difference('Msg.count') do
      post msgs_url, params: { msg: { cate_id: @msg.cate_id, content: @msg.content, title: @msg.title } }
    end
  ...
  test "should update msg" do
    patch msg_url(@msg), params: { msg: { cate_id: @msg.cate_id, content: @msg.content, title: @msg.title } }

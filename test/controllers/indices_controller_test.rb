...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post indices_url, params: { index: { content: @index.content, images: @index.images, name: @index.name } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { content: @index.content, images: @index.images, name: @index.name } }
